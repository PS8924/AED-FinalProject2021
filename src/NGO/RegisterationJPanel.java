...
public class RegisterationJPanel extends javax.swing.JPanel {
    ...
    public RegisterationJPanel(JPanel RightPanel,OrganizationDirectory organizationdirectory) {
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(88, 88, 88)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(organizationJComboBox, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void populateTable(Organizations organization){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if(nameJTextField.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Please enter the NGO Volunteer's name!");
            return;
        }
        else{
            for(User user:organization.getUserDirectory().getUserList())
            {
                if(nameJTextField.getText().equalsIgnoreCase(user.getName())){
                    JOptionPane.showMessageDialog(null,"This volunteer already exists !");
                    return;
                }
            }
            organization.getUserDirectory().createUser(name);
